...
-- Tiempo de generación: 22-07-2024 a las 23:04:57
...
CREATE TABLE `assistence` (
  ...
  `time_entry` varchar(8) DEFAULT NULL,
  `time_exit` varchar(8) DEFAULT NULL,
  `work_completed` varchar(8) DEFAULT NULL,
  `time_to_recover` varchar(8) DEFAULT NULL,
  `break_completed` varchar(8) DEFAULT NULL,
  `additional_time` varchar(8) DEFAULT NULL,
  `dealy_breaks` varchar(10) DEFAULT NULL,
  `lunch_time` int(11) NOT NULL,
  `remaining_lunch_hour` int(11) NOT NULL,
...
INSERT INTO `assistence` (`id`, `employee_id`, `time_entry`, `time_exit`, `work_completed`, `time_to_recover`, `break_completed`, `additional_time`, `dealy_breaks`, `lunch_time`, `remaining_lunch_hour`, `date`) VALUES
(1, 26, '17:48:45', '17:48:52', '00:00:00', '07:45:00', '00:00:00', '45:00', '1', 0, 0, '2024-07-08'),
(2, 30, '12:00:00', '16:00:00', '02:00:00', '01:45:00', '00:00:00', '45:00', '1', 0, 0, '2024-07-20'),
(3, 30, '11:00:00', '18:00:00', '03:00:00', '00:45:00', '00:15:00', '05:00', '3', 45, 5, '2024-07-22');

--
-- Disparadores `assistence`
--
DELIMITER $$
CREATE TRIGGER `before_insert_assistence` BEFORE INSERT ON `assistence` FOR EACH ROW BEGIN
...
(26, 'EWJ471530826', 'Isidro Alexander ', 'Marroquin Echeverria', 'San Martin, San Salvador', '2000-09-22', '2021rodrigo.rodriguez@gmail.com', 'Male', 1, 5, 'm2.jpeg', '2024-04-01', '7ymIuRDTz95k3C66A0Ijcec9xHJIpjZ0S1SB+Lf+lJI='),
...
CREATE TABLE `nomina` (
  ...
  `work_completed` varchar(8) DEFAULT NULL,
  `time_to_recover` varchar(8) DEFAULT NULL,
  `break_completed` varchar(5) DEFAULT NULL,
  `additional_time` varchar(5) DEFAULT NULL,
  `date` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `employees`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Key_Position` (`position_id`);
...
--
-- Filtros para la tabla `assistence`
--
ALTER TABLE `assistence`
  ADD CONSTRAINT `assistence_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`);

--
-- Filtros para la tabla `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `FK_Key_Position` FOREIGN KEY (`position_id`) REFERENCES `position` (`id`);

--
-- Filtros para la tabla `nomina`
--
ALTER TABLE `nomina`
  ADD CONSTRAINT `nomina_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`);
COMMIT;
